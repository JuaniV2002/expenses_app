...
-  Una vez que finalizó la creación del nuevo proyecto, añade la carpeta assets en tu nuevo proyecto, y reemplaza la carpeta lib y pubspecs (pubspec.yaml y pubspec.lock) con las que yo proveo en este repositorio.
